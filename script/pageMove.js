...
EpilogueBtn.addEventListener("mousedown", function () {
  EpilogueBtn.classList.add("active");
});
EpilogueBtn.addEventListener("mouseup", function () {
  EpilogueBtn.classList.remove("active");
});
